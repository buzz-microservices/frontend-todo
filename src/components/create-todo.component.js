...
export default class CreateTodo extends Component {
    ...
    constructor(props) {
        ...
        this.onChangeTodoTimezone = this.onChangeTodoTimezone.bind(this);
    ...
    onChangeTodoTimezone(e) {
        this.setState({
            todo_timezone: e.target.value
        });
    }
    ...
    onSubmit(e) {
        ...
        var time = new Date().toLocaleString("en-US", {timeZone: res.data[0].timeZoneId});
        //time = new Date(time);
